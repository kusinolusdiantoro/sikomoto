...
<head>
  ...
  <title>SIABEKA | Registration</title>
...
<div class="login-box" style="border-radius: 15px; box-shadow: 4px 5px 6px 6px">
  ...
  <div class="card" style="border-radius: 15px; box-shadow: 4px 5px 6px 6px">
    <div class="card-body login-card-body" style="border-radius: 15px ">
      <h4 class="text-center" style="color: black; font-weight:bold"><b>SIABEKA</b></h4>
      <div class="text-center mb-2">
        <img src="<?= base_url('assets/img/poltek.png')?>"  alt="login" style="width: 100px;">
      </div>
      <h6 class="text-center mb-3" style="color: black; font-weight:bold">Sistem Informasi Analisis Beban Kerja</h6>
    ...
    <?php endif; ?>
      ...
      <?php echo form_open_multipart('Auth/doTambahAkun') ?>
        ...
        <div>
          ...
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block" id="tombol">Daftar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
